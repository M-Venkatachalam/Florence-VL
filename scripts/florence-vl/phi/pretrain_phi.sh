...
export OUTPUT=/fsx_0/user/jiuhai/model/llava-pretrain-pixelprose-Phi3-second

export SAVE_PATH=phi3-pretrained-pixelprose
...
srun -p q1 \
    ...
    --model_name_or_path  /fsx_0/user/jiuhai/hub/models--microsoft--Phi-3.5-mini-instruct/snapshots/64963004ad95869fa73a30279371c8778509ac84 \
    --version plain \
    --data_path ${DATA_PATH} \
    --image_folder ${IMG} \
